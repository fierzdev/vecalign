...
def _main():
    ...
    align(args.src, args.tgt, args.src_embed, args.tgt_embed, args.gold_alignment, args.alignment_max_size, args.search_buffer_size, args.del_percentile_frac, args.max_size_full_dp,
          args.costs_sample_size, args.num_samps_for_norm, args.verbose, args.debuge_save_stack)


def align(src, tgt, src_embed, tgt_embed, gold_alignment=None, alignment_max_size=4, search_buffer_size=5, del_percentile_frac=0.2, max_size_full_dp=300, costs_sample_size=20000,
          num_samps_for_norm=100, verbose=False, debug_save_stack=None):
    if len(src) != len(tgt):
